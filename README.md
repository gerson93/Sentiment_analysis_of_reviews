...
We'll go over 8 different ways to analyze reviews. In this case, we will work with a dataset from Kaggle. This dataset contains reviews about a capuccino cup, with a five star column rating - 1 (negative) to 5 (positive). We'll start preprocessing our reviews by creating one column, with a "positive" label, if the review has 4 or 5 star, and with a "negative" label, if the review has 1 or 2 star. Reviews with 3 star will be drop. Finally, this column will be our target.
